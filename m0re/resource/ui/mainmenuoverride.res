"resource/ui/mainmenuoverride.res"
{
	...
	{
		"ControlName"  "EditablePanel"
		"wide"  "f0" "tall"  "f0" "zpos" "-10000"
		"CustomShaderOverlay"
		{
			"ControlName" "ImagePanel"
			"zpos" "-10000" "wide" "f0" "tall" "480" "scaleimage" "1"
			"image" "replay/thumbnails/shaders/blur"
		}
		"CustomShaderOverlayBG"
		{
			"ControlName"   "EditablePanel"
			"zpos" "1" "wide" "f0" "tall" "480" "scaleimage" "1"
			"bgcolor_override" "255 255 255 5"
		}
	}

	//"ChatPin"{"ControlName" "Panel" "xpos" "rs1-120" "ypos" "30"}
	//"partychat"{"pin_to_sibling"    "ChatPin"}
